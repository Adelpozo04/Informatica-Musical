...
class SynthFMHarmonic:
    def __init__(self,
        ...
        self.fundamental = OscFM(self.fc,amp=self.amp,fm=self.fm,beta=self.beta) # generador
        #self.tercera = OscFM(660,amp=self.amp,fm=self.fm,beta=self.beta) # generador
        #self.quinta = OscFM(825 ,amp=self.amp,fm=self.fm,beta=self.beta) # generador
